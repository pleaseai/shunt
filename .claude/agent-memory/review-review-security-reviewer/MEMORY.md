...
- [Sentry transaction hostname leak](project_sentry-transaction-hostname-leak.md) — perf-tracing transactions bypass before_send/scrub_event (no before_send_transaction in 0.48.4), so machine hostname leaks despite "never sent" contract.
