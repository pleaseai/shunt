...
- [codex-subagent msgstart-input review](shunt-codex-subagent-msgstart-input-review.md) — branch stale vs origin/main (diff against merge-base, not raw origin/main); usage_value() zero-sentinel edge case.
