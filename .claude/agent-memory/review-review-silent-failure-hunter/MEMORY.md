...
- [PR #125 codex passthrough endpoint](pr125-codex-passthrough-endpoint.md) — codex_endpoint.rs::forward() discards AdapterError.message and logs nothing on most failure exits (unlike proxy::post's ForwardError); plus Anthropic-shaped error envelopes on a raw OpenAI-Responses endpoint.
