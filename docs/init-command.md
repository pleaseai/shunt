...
The accepted preset names are `anthropic`, `codex`, `openai`, `xai`, `grok`, `kimi`, `cursor`, `kimi-code`, `zhipu`, `minimax-cn`, and `opencode`. Unknown and duplicate values fail before the file is opened.
