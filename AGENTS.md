...
- `site/src/content/docs/` — update the affected guide/reference page when user-facing behavior, config keys, endpoints, or CLI changes (`guides/` for how-tos, `reference/` for config/endpoints/CLI/troubleshooting).
