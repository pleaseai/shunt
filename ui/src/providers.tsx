...
/**
 * The label an operator recognizes, which is not always the config key: the
 * `codex` provider is what the vendor calls GPT, and showing the internal name
 * made the usage table read as if it listed something else.
 */
