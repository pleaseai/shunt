...
list from the first Anthropic-kind upstream and falls back to shunt's builtin Claude catalog
snapshot when that list is unavailable — see [Model Discovery](/guides/model-discovery/).
