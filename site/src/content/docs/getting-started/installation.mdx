...
drains in-flight requests before exiting. Config changes don't need a restart — shunt
[hot-reloads](https://github.com/pleaseai/shunt/blob/main/docs/config-reload.md) the file
automatically. See [Running as a
