...
**Discovery filter.** Claude Desktop's auto-discovery shows only *recognizably Claude* ids — the tier-named ones (`claude-sonnet-*`, `claude-opus-*`, `claude-haiku-*`, `claude-fable-*`). shunt's builtin catalog is the superset of what the Anthropic API and the reference Claude apps gateway serve — thirteen tier-named ids, so Claude Desktop shows every one. This is the fallback snapshot; when shunt can reach your Anthropic upstream it serves that caller's own live list instead (see [Model Discovery](/guides/model-discovery/)).

```json
// GET /v1/models — builtin catalog (auto_include_builtin_models), all tier-named
// (each entry also carries "type": "model", "display_name", "created_at",
//  "max_input_tokens", and "max_tokens")
{ "data": [
  { "id": "claude-opus-5-5" },   { "id": "claude-fable-5-1" },
  { "id": "claude-opus-5" },     { "id": "claude-sonnet-5" },
  { "id": "claude-fable-5" },    { "id": "claude-opus-4-8" },
  { "id": "claude-opus-4-7" },   { "id": "claude-sonnet-4-6" },
  { "id": "claude-opus-4-6" },   { "id": "claude-opus-4-5-20251101" },
  { "id": "claude-haiku-4-5-20251001" }, { "id": "claude-sonnet-4-5-20250929" },
  { "id": "claude-opus-4-1-20250805" }
], "has_more": false,
   "first_id": "claude-opus-5-5", "last_id": "claude-opus-4-1-20250805" }
```
